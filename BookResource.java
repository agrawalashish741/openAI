...
import com.sismics.books.core.dao.jpa.criteria.*;
import com.sismics.books.core.dao.jpa.dto.*;
...
import com.sismics.books.core.util.*;
...
public class BookResource extends BaseResource {
    ...
    @Path("{id: [a-z0-9\\-]+}")
    @Produces(MediaType.APPLICATION_JSON)
    public Response updateBook(@PathParam("id") String userBookId,
    ...
    public Response getBookCover(@PathParam("id") final String userBookId) throws JSONException {
        UserBookDao userBookDao = new UserBookDao();
    ...
    @Path("{id: [a-z0-9\\-]+}/cover")
    @Produces(MediaType.APPLICATION_JSON)
    public Response updateBookCover(@PathParam("id") String userBookId,
    ...
    @Path("list")
    @Produces(MediaType.APPLICATION_JSON)
    public Response listBooks(@QueryParam("limit") Integer limit,
